...
tar -xf tor-browser-linux32-11.0.6_en-US.tar.xz

echo Deleting Tor Browser package to free space

rm tor-browser-linux32-11.0.6_en-US.tar.xz

echo Moving to Tor Browser directory

cd /Download/tor-browser-linux32-11.0.6_en-US
